...
class CallKitController : NSObject {
    ...
    static var providerConfiguration: CXProviderConfiguration = {
        ...
        // let iconImage = UIImage(named: "CallKitIcon")
        let iconImage = UIImage(named: "BanccCallKitIcon")
    ...
    static func updateConfig(
        ...
        //         print("Error: Image named \(icon) not found.")
        //         return
        //     }
        //     guard let iconData = iconImage.pngData() else {
